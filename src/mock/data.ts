...
> = {
  ...
  '/approvals': {
    title: '审批中心',
    subtitle: '生产发布与高风险变更审批 Gate，全程可审计',
    quote: '没有审批，就没有生产发布',
    search: '搜索审批单、申请人、版本...',
  },
  '/alerts': {
...
export const approvals = [
  { id: 'A-318', title: '生产发布 mall v2.1.0', risk: '高', applicant: '张三', env: 'Production', status: '待审批', time: '今天 09:50' },
  { id: 'A-317', title: '扩容 order-service ×2', risk: '中', applicant: '李四', env: 'Production', status: '审批中', time: '今天 09:20' },
  { id: 'A-316', title: '回滚 pay v1.5.5', risk: '高', applicant: '王五', env: 'Production', status: '待审批', time: '昨天 19:12' },
  { id: 'A-315', title: '更新 Staging 证书', risk: '低', applicant: '陈六', env: 'Staging', status: '已通过', time: '昨天 15:00' },
]
