...
const routes = [
  ...
  { title: '版本管理2', path: '/versions-v2', icon: <TagsOutlined />, keywords: 'version 版本管理2 制品 对比' },
  ...
  { title: '监控中心', path: '/monitor', icon: <MonitorOutlined />, keywords: 'monitor 监控 拓扑 SLA' },
  { title: '客户中心', path: '/customers', icon: <ContactsOutlined />, keywords: 'customer 客户 回款 验收' },
  { title: '验收中心', path: '/acceptance', icon: <FileProtectOutlined />, keywords: 'acceptance 验收 交付' },
